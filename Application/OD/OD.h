...
typedef struct {
    ...
    uint8_t x2000_servoPositions_sub0;
    uint16_t x2000_servoPositions[OD_CNT_ARR_2000];
    int16_t x2001_motorSpeed;
} OD_RAM_t;
...
#define OD_ENTRY_H2000_servoPositions &OD->list[21]
#define OD_ENTRY_H2001_motorSpeed &OD->list[22]
