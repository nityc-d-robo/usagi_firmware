...
OD_ATTR_RAM OD_RAM_t OD_RAM = {
    ...
    .x2000_servoPositions_sub0 = 0x04,
    .x2000_servoPositions = {0x05DC, 0x05DC, 0x05DC, 0x05DC},
    .x2001_motorSpeed = 0
};
...
typedef struct {
    ...
    OD_obj_array_t o_2000_servoPositions;
    OD_obj_var_t o_2001_motorSpeed;
} ODObjs_t;
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_2000_servoPositions = {
        .dataOrig0 = &OD_RAM.x2000_servoPositions_sub0,
        .dataOrig = &OD_RAM.x2000_servoPositions[0],
        .attribute0 = ODA_SDO_R,
    ...
    .o_2001_motorSpeed = {
        .dataOrig = &OD_RAM.x2001_motorSpeed,
        .attribute = ODA_SDO_RW | ODA_RPDO | ODA_MB,
        .dataLength = 2
    }
};
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x2000, 0x05, ODT_ARR, &ODObjs.o_2000_servoPositions, NULL},
    {0x2001, 0x01, ODT_VAR, &ODObjs.o_2001_motorSpeed, NULL},
